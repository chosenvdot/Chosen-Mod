...
NDefines.NCountry.PS_MAKE_PROVINCE_CORE = 5.5		-- from 10
...
NDefines.NDiplomacy.PEACE_COST_RETURN_CORE = 0.6			-- from 1 Some peace cost changes moved from Misc Addon to Main BT where they overlap returning a core to a rightful owner should be a less dramatic negotiating factor than taking a completely new province
...
NDefines.NDiplomacy.PO_DEMAND_PROVINCES_AE = 0.6			-- from 0p75
...
NDefines.NMilitary.BASE_MP_TO_MANPOWER = 0.15			-- from 0p25
