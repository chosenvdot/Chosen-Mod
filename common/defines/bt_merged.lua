...
NDefines.NDiplomacy.AE_ATTACKER_DEVELOPMENT = 0.002			-- from 0p01
NDefines.NDiplomacy.AE_DEFENDER_DEVELOPMENT = 0.002			-- from 0p01
NDefines.NDiplomacy.AE_PROVINCE_CAP = 15			-- from 30
...
NDefines.NDiplomacy.PO_DEMAND_PROVINCES_AE = 0.1			-- from 0p75
...
NDefines.NReligion.MAX_CHRISTIAN_RELIGIOUS_CENTERS = 3			-- BTAddOn changed from 3 Compensating for more provinces and more tags Ive seen too many games with only 3 protestant and reformed countries because all CoR hit in the same area Apparently doesnt work leaving it anyway
